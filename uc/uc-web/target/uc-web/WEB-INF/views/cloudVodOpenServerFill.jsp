...
<div class="comwidth clearfix">
         ...
         <dl class="cdn-info pull-left clearfix">
             <dt class="clearfix">
                <ul id="cdnTab" class="cdntags clearfix">
                  <li class="active"><a href="#liuliangInfo">按流量<i class="arrow"></i></a></li>
                  <li><a class="" href="#daikuanInfo">按宽带<i class="arrow"></i></a></li>
                 </ul>
             </dt>
    ...
    <div class="btn-zhibo  clearfix"><a href="${ctx}/cloud" class="btn-primary btn-xxl">开通服务</a></div>
</div>
<!--main /E-->
<!-- 引入底部foot-->
<!-- footer/S-->
