...
<div class="emailBody">
    ...
    <div class="email-content clear">
        ...
        <h3>
            <p>感谢您注册成为乐视云计算会员，您的登陆邮箱为：<a href="" style="display: inline;">${currentUserEmail}</a>，请牢记！</p>
            <p>点击按钮完成邮箱认证并登录：</p>
        </h3>
        <a href="${href}"><input type="button" nume="password"  value="登录乐视云计算"/></a>
        <h3>
            <p>或点击以下链接完成邮箱认证：</p>
            <a href="${href}">${href}</a>
        </h3>
