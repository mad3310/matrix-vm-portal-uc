				...
				<div class="zizhi-edit-wj clearfix" style="padding-top:0px">
					<form class="form-horizontal"  method="post">
						...
						<div class="form-group clearfix">
						    <label class="le-col-3 le-col-md-4 control-label">真实名称:</label>
						    <div class="le-col-5 le-col-md-6">
						       <p class="form-control-static">${user.contacts }</p>
						    </div>
						</div>
						<div class="form-group clearfix">
						    <label  class="le-col-3 le-col-md-3 control-label">身份证号:</label>
						     <div class="le-col-5 le-col-md-6">
						       <p class="form-control-static">${user.idCard }</p>
						    </div>
						</div>
						<div class="form-group clearfix">
						    <label  class="le-col-3 le-col-md-3 control-label">身份证：</label>
						    <div class="le-col-6 le-col-md-7">
						       <div class="row clearfix">
						       	   <div class="le-col-4">
									   <p class="zizhi-yyzz-face-wj" style="border: 0px;">
							       	  	<img src="${user.idCardPhoto }" />
							       	  </p>
							       </div>
							       <div class="le-col-8">
									  <div class="clearfix">
						...
						<div class="form-group clearfix">
						    <label  class="le-col-3 le-col-md-3 control-label">联系地址：</label>
