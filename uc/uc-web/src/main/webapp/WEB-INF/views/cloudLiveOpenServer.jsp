...
<div class="service-on">
	...
	<div class="row">
		<div class="le-col-1 service-on-left">赠送服务：</div>
		<div class="le-col-4 service-on-right">即日起开通云直播服务，免费为您同时开通<a href="#" class="text-primary a-has-decoration">云点播</a>服务</div>
	</div>
	<div class="row">
	...
	<div class="row">
		<a href="#" class="btn btn-primary btn-lg btn-big ml-20" id="btn-open-service">开通服务</a>
	</div>
	</div>
</div>
  ...
  <div class="modal-dialog" style="width: 480px;">
    <div class="modal-content">
      ...
      <div class="row text-center upload-success-tankuang-info">
      	...
      	<p class="h4">云直播服务已开通</p>
      	<p class="text-center ml-20">3s后自动跳转云直播控制台</p>
      </div>
 	  <div class="row" style="padding-bottom: 54px;">
        <button type="button" class="btn btn-primary" style="padding: 6px 20px;margin-left: 70px;">点播控制台</button>
        <a href="#" class="text-primary ml-10">了解更多产品>></a>
        <button type="button" class="btn btn-primary ml-10" style="padding: 6px 20px;">直播控制台</button>
      </div>
      </div>
    </div>
  </div>
