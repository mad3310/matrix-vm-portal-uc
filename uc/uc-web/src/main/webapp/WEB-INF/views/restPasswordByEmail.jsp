...
<section class="le-section-user comwidth clearfix">
	<div class="password">
		<div class="account">邮箱： ${email }</div>
		<div class="resetpassword-wraper">
			<form class="form-horizontal vform" action="${ctx }/restPassword/modifyPwdByEmail.do" role="form" method="post" onsubmit="return submitCheck()">
...
|...usercenter-resetPassword-mail.html
