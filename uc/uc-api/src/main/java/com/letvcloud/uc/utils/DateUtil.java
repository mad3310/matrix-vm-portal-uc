...
public class DateUtil {
	...
	public static String getDate4() {
		Date rightNow = new Date();
		String dateString = (new SimpleDateFormat("yyyyMMddHHmmss")).format(rightNow);
		return dateString;
	}
	 ...
	 * @throws ParseException
	 */
	public static int dateCompare(String fmt, String date1, String date2) throws ParseException {
		SimpleDateFormat sdf = new SimpleDateFormat(fmt);
	...
	public static String getStryyyyMMddHH() {
		Date rightNow = new Date();
		String dateString = (new SimpleDateFormat("yyyyMMddHH")).format(rightNow);
		return dateString;
	}
	 ...
	 * @return
	 */
	public static List<String> getTimeline(Date startDate, Date endDate, int field) {
	 ...
	 * @return
	 */
	public static List<String> getTimeline(Date startDate, Date endDate, String format, int field, int step) {
		Calendar scal = Calendar.getInstance();
		scal.setTime(startDate);
		Calendar ecal = Calendar.getInstance();
		ecal.setTime(endDate);
    ...
    /** 获取月份起始日期 */
    public static String getMinMonthDate(Date date, String fmt) throws ParseException {
    ...
    /** 获取月份最后日期 */
    public static String getMaxMonthDate(Date date, String fmt) throws ParseException {
