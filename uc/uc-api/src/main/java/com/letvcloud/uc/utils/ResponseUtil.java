...
public class ResponseUtil{
    ...
    public static void sendJsonpNoCache(HttpServletResponse response, String callback, JsonResult jsonResult)
            throws IOException {
    ...
    public static void sendJsonpNoCache(HttpServletResponse response, String callback, String message)
            throws IOException {
    ...
    public static void sendMessageNoCache(HttpServletResponse response, String message, String contentType)
            throws IOException {
    ...
    public static void sendMessageWithCache(HttpServletResponse response, String message, String contentType,
            int cacheSec) throws IOException {
    ...
    public static void setCrossDomain(HttpServletResponse response) {
        ...
        response.setHeader(
                ...
                "Origin, No-Cache, X-Requested-With,Content-Range, X_FILENAME, If-Modified-Since, Pragma, Last-Modified, Cache-Control, Expires, Content-Type, X-E4M-With");
    }
    ...
    public static String addParam(String url, JSONObject paramValuePair) {
        ...
        for (Map.Entry<String, Object> entry : paramValuePair.entrySet()) {
            if (sb.length() > 0)
                sb.append('&');
            try {
                sb.append(encode(entry.getKey(), "UTF-8")).append('=')
                        .append(encode(entry.getValue().toString(), "UTF-8"));
