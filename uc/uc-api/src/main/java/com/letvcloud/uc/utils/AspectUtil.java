...
public class AspectUtil{
     ...
     */
    public static Method getMethod(ProceedingJoinPoint j) throws ClassNotFoundException, SecurityException,
    ...
    private static Class<?> getClass(String className) throws ClassNotFoundException {
        ...
        Class<?> clazz = null;
        Class<?>[] clazzes = new Class<?>[] { byte.class, short.class, int.class, long.class, char.class,
